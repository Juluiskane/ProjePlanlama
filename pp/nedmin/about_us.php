            ...
            <form class="form-horizontal form-label-left" action="process.php" method="POST">
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-7 col-xs-12" name="about_title" value="<?php echo $fetch['about_title'] ?>"  required="required" type="text">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Biyografi
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea id="textarea"  name="content"<?php echo $fetch['content'] ?>  required="required" class="form-control col-md-7 col-xs-12" rows="5"><?php echo $fetch['content'] ?></textarea>
                </div>
              </div>
              <div class="item form-group">
