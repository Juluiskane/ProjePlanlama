      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <form class="form-horizontal form-label-left" action="process.php" method="POST">
            ...
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12">Konum linki
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="location_link"  value="<?php echo $fetch['location_link'] ?>" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="item form-group">
